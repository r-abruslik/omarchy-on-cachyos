...
if [[ -f "install/config/all.sh" ]]; then
  # Keep nvidia.sh for legacy drivers - DO NOT disable this patch
  echo "  ✓ Keeping NVIDIA configuration (legacy driver support)"
fi
...
echo "✓ NVIDIA legacy driver support enabled"
echo "✓ Fish configured"
echo ""
